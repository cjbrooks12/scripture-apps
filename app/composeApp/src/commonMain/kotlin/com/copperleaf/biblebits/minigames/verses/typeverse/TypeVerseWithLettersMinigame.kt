...
@Composable
fun TypeVerseWithLettersMinigame(
    ...
    Column {
        ...
        Text("Type out the verse using the first letter of the word as a guide", style = MaterialTheme.typography.headlineMedium)
