...
import com.copperleaf.scripturenow.routing.MainRouterViewModel
import com.copperleaf.scripturenow.verses.OurMannaApiBaseUrlKey
import com.copperleaf.scripturenow.verses.RepositoryConfigBuilder
import com.copperleaf.scripturenow.verses.RepositoryCoroutineScope
import com.copperleaf.scripturenow.verses.VerseOfTheDayRepository
import com.copperleaf.scripturenow.verses.votdModule
...
class Injector(
    ...
    val mainRouter: MainRouterViewModel get() = kodein.instance<MainRouterViewModel>()
}
